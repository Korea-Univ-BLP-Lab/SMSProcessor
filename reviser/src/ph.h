/* Phoneme-type hangul processing library header */
...
typedef struct
{
  unsigned char i;              /* phoneme : initial */
  unsigned char m;              /* phoneme : medial */
  unsigned char f;              /* phoneme : final */
}
tPH;

extern void ConvertToPhoneme (char *str, tPH * tmp);
extern void ConvertToTrigem (char *str, tPH * tmp);
extern short IsPositiveVowel (unsigned char phm);
extern void CopySyllable (char *str, unsigned char phi, unsigned char phm,
                          unsigned char phf);

extern unsigned char GetInitialPhoneme (char *str);
extern unsigned char GetMedialPhoneme (char *str);
extern unsigned char GetFinalPhoneme (char *str);
extern unsigned char GetInitialPhoneme_KS (const char *str);
extern unsigned char GetMedialPhoneme_KS (const char* str);
extern unsigned char GetFinalPhoneme_KS (char *str);

/* Value of phoneme-type hangul code */
...
#define PHF_RT  (unsigned char)14       /* 辆己 ぴぴぴぎ */
#define PHF_RP  (unsigned char)15       /* 辆己 ぴぴぴく */
#define PHF_RH  (unsigned char)16       /* 辆己 ぴぴぴぐ */
