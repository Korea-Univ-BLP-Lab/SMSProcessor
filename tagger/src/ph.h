...
extern void CopySyllable (char* str, unsigned char phi, unsigned char phm, unsigned char phf);
...
#define PHM_AI	(unsigned char)4	/* 吝己 ち */
#define PHM_YA	(unsigned char)5	/* 吝己 だ */
